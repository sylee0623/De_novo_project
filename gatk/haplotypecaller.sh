...
for ((a=1;a<=5;a++))
do
qsub -lvnode=biglab1 -j oe -o HC1_5 -- /lustre/export/home/sylee/programfile/gatk-4.1.7.0/gatk --java-options "-Xmx5g -Xms5g" HaplotypeCaller \
...
for ((a=6;a<=10;a++))
do
qsub -lvnode=biglab2 -j oe -o HC1_5 -- /lustre/export/home/sylee/programfile/gatk-4.1.7.0/gatk --java-options "-Xmx5g -Xms5g" HaplotypeCaller \
    --input /lustre/export/home/sylee/Hanchinese/try3/result/gatk/daughter.sorted.markdup.BQSR.bam \
    --output /lustre/export/home/sylee/Hanchinese/try3/result/gatk/HaplotypeCaller/chr${a}.hc.g.vcf.gz \
    --reference ${reference} \
    --emit-ref-confidence GVCF \
...
for ((a=11;a<=22;a++))
do
qsub -lvnode=biglab3 -j oe -o HC1_5 -- /lustre/export/home/sylee/programfile/gatk-4.1.7.0/gatk --java-options "-Xmx5g -Xms5g" HaplotypeCaller \
    --input /lustre/export/home/sylee/Hanchinese/try3/result/gatk/daughter.sorted.markdup.BQSR.bam \
    --output /lustre/export/home/sylee/Hanchinese/try3/result/gatk/HaplotypeCaller/chr${a}.hc.g.vcf.gz \
    --reference ${reference} \
    --emit-ref-confidence GVCF \
